...
# video_poses = np.load("demo_points3d_list.npy")
...
vis.register_key_callback(77, lambda vis: keyboard_callback(vis, ord('M'), 0, mesh, base_trans_vector, frame_id, scale_size))  # Key 'M' scale +
vis.register_key_callback(78, lambda vis: keyboard_callback(vis, ord('N'), 0, mesh, base_trans_vector, frame_id, scale_size))  # Key 'N' scale -
