    ...
    def run_advanced(self):
        while True:
            ...
            if len(image_list) > 1:
                ...
                results0, results1 = neural_network_process(self.detection_model, self.model, img0_undistorted, img1_undistorted, self.connections)
            ...
            self.update_cv2_windows2("Camera 0", img0_undistorted)
            self.update_cv2_windows2("Camera 1", img1_undistorted)
